    ...
    return (
        <div className="h-17.5 bg-custom-gradient text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px:8 px-4 w-full flex justify-between">
                ...
                <ul className={`flex sm:gap10 gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-17.5 sm:shadow-none shadow-md 
                    ...
                    <li className="font-medium transition-all duration-150">
                        <Link className="flex items-center space-x-2 px-4 py-1.5
                            ...
                            text-white font-semibold rounded-md shadow-lghover:from-purple-500 hover:to-red-400
